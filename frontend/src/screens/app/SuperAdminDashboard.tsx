...
export const SuperAdminDashboard: React.FC<SuperAdminDashboardProps> = ({
  ...
  // ==================== 2. BACKUP & RECOVERY STATE ====================
  const [backups, setBackups] = useState([
    { id: 'BKP-1089', date: '2026-07-25 02:00 AM', type: 'Automated Full Backup', status: 'Healthy', size: '1.42 GB', duration: '3m 12s' },
    { id: 'BKP-1088', date: '2026-07-24 02:00 AM', type: 'Automated Full Backup', status: 'Healthy', size: '1.40 GB', duration: '3m 05s' },
    { id: 'BKP-1087', date: '2026-07-23 02:00 AM', type: 'Incremental Snapshot', status: 'Healthy', size: '380 MB', duration: '48s' },
    { id: 'BKP-1086', date: '2026-07-22 02:00 AM', type: 'Automated Full Backup', status: 'Failed', size: '0 MB', duration: '12s' },
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto space-y-8">
          ...
          {activeRoute === '/superadmin/dashboard' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <Card className="p-5 border border-[#E7E4DF] hover:shadow-md transition-all">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="p-2 rounded-xl bg-[#EBF7EE] text-[#2E7D32]">
              ...
              {/* Quick Navigation Cards Grid to all 9 modules */}
              <div>
            ...
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="p-5">
                  ...
                  <div className="font-heading text-xl font-extrabold text-[#1A1A1A] mt-1">Today, 02:00 AM</div>
                  <span className="text-xs text-[#2E7D32] font-semibold mt-1 block">Full Snapshot (1.42 GB)</span>
                </Card>
                    ...
                    <tbody className="divide-y divide-[#E7E4DF]">
                      {backups.map((bkp) => (
                        <tr key={bkp.id} className="hover:bg-[#FAF8F2]">
                          <td className="py-3 font-mono font-bold text-[#1A1A1A]">{bkp.id}</td>
                          <td className="py-3 text-[#666666]">{bkp.date}</td>
                          ...
                          <td className="py-3">
                            <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold ${
                              bkp.status === 'Healthy'
                                ...
                                : bkp.status === 'Running'
                                ? 'bg-[#EBF3FA] text-[#2A5C8A] animate-pulse'
                          ...
                          <td className="py-3 text-right space-x-2">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() => {
                                showToast({ title: 'Downloading Logs', message: `Logs for ${bkp.id} downloaded.`, type: 'info' });
                              }}
                            >
                              Log
                            </Button>
